...
[![arm32v5/caddy build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/caddy.svg?label=arm32v5/caddy%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/caddy/)
...
Note the second `FROM` instruction - this produces a much smaller image by simply overlaying the newly-built binary on top of the the regular `arm32v5/caddy` image.
